...
ESPWebSocketsClient::ESPWebSocketsClient() {
    _cbEvent             = NULL;
    _client.num          = 0;
 ...
 */
void ESPWebSocketsClient::begin(const char * host, uint16_t port, const char * url, const char * protocol) {
    _host = host;
    _port = port;
#if defined(HAS_SSL)
...
void ESPWebSocketsClient::begin(String host, uint16_t port, String url, String protocol) {
    begin(host.c_str(), port, url.c_str(), protocol.c_str());
}

void ESPWebSocketsClient::begin(IPAddress host, uint16_t port, const char * url, const char * protocol) {
    return begin(host.toString().c_str(), port, url, protocol);
}

#if defined(HAS_SSL)
#if defined(SSL_AXTLS)
void ESPWebSocketsClient::beginSSL(const char * host, uint16_t port, const char * url, const char * fingerprint, const char * protocol) {
...
void ESPWebSocketsClient::beginSSL(String host, uint16_t port, String url, String fingerprint, String protocol) {
    beginSSL(host.c_str(), port, url.c_str(), fingerprint.c_str(), protocol.c_str());
}

void ESPWebSocketsClient::beginSslWithCA(const char * host, uint16_t port, const char * url, const char * CA_cert, const char * protocol) {
    begin(host, port, url, protocol);
    _client.isSSL = true;
    _fingerprint  = SSL_FINGERPRINT_NULL;
    _CA_cert      = CA_cert;
...
#else
void ESPWebSocketsClient::beginSSL(const char * host, uint16_t port, const char * url, const uint8_t * fingerprint, const char * protocol) {
    begin(host, port, url, protocol);
    _client.isSSL = true;
    _fingerprint  = fingerprint;
    _CA_cert      = NULL;
...
void ESPWebSocketsClient::beginSslWithCA(const char * host, uint16_t port, const char * url, BearSSL::X509List * CA_cert, const char * protocol) {
    begin(host, port, url, protocol);
    _client.isSSL = true;
    _fingerprint  = SSL_FINGERPRINT_NULL;
    _CA_cert      = CA_cert;
...
void ESPWebSocketsClient::setSSLClientCertKey(BearSSL::X509List * clientCert, BearSSL::PrivateKey * clientPrivateKey) {
    _client_cert = clientCert;
    _client_key  = clientPrivateKey;
}

void ESPWebSocketsClient::setSSLClientCertKey(const char * clientCert, const char * clientPrivateKey) {
...
void ESPWebSocketsClient::beginSocketIO(const char * host, uint16_t port, const char * url, const char * protocol) {
    begin(host, port, url, protocol);
    _client.isSocketIO = true;
}

void ESPWebSocketsClient::beginSocketIO(String host, uint16_t port, String url, String protocol) {
    beginSocketIO(host.c_str(), port, url.c_str(), protocol.c_str());
}

#if defined(HAS_SSL)
void ESPWebSocketsClient::beginSocketIOSSL(const char * host, uint16_t port, const char * url, const char * protocol) {
    begin(host, port, url, protocol);
    _client.isSocketIO = true;
    _client.isSSL      = true;
    _fingerprint       = SSL_FINGERPRINT_NULL;
...
void ESPWebSocketsClient::beginSocketIOSSL(String host, uint16_t port, String url, String protocol) {
    beginSocketIOSSL(host.c_str(), port, url.c_str(), protocol.c_str());
}

#if defined(SSL_BARESSL)
void ESPWebSocketsClient::beginSocketIOSSLWithCA(const char * host, uint16_t port, const char * url, BearSSL::X509List * CA_cert, const char * protocol) {
    begin(host, port, url, protocol);
    _client.isSocketIO = true;
    _client.isSSL      = true;
    _fingerprint       = SSL_FINGERPRINT_NULL;
...
void ESPWebSocketsClient::beginSocketIOSSLWithCA(const char * host, uint16_t port, const char * url, const char * CA_cert, const char * protocol) {
    begin(host, port, url, protocol);
    _client.isSocketIO = true;
    _client.isSSL      = true;
    _fingerprint       = SSL_FINGERPRINT_NULL;
 ...
 */
void ESPWebSocketsClient::loop(void) {
    if(_port == 0) {
        return;
    }
    WEBSOCKETS_YIELD();
 ...
 */
void ESPWebSocketsClient::onEvent(ESPWebSocketClientEvent cbEvent) {
    _cbEvent = cbEvent;
}
 ...
 * @return true if ok
 */
bool ESPWebSocketsClient::sendTXT(uint8_t * payload, size_t length, bool headerToPayload) {
    if(length == 0) {
...
bool ESPWebSocketsClient::sendTXT(const uint8_t * payload, size_t length) {
    return sendTXT((uint8_t *)payload, length);
}

bool ESPWebSocketsClient::sendTXT(char * payload, size_t length, bool headerToPayload) {
    return sendTXT((uint8_t *)payload, length, headerToPayload);
}

bool ESPWebSocketsClient::sendTXT(const char * payload, size_t length) {
    return sendTXT((uint8_t *)payload, length);
}

bool ESPWebSocketsClient::sendTXT(String & payload) {
    return sendTXT((uint8_t *)payload.c_str(), payload.length());
}

bool ESPWebSocketsClient::sendTXT(char payload) {
 ...
 * @return true if ok
 */
bool ESPWebSocketsClient::sendBIN(uint8_t * payload, size_t length, bool headerToPayload) {
    if(clientIsConnected(&_client)) {
...
bool ESPWebSocketsClient::sendBIN(const uint8_t * payload, size_t length) {
 ...
 */
bool ESPWebSocketsClient::sendPing(uint8_t * payload, size_t length) {
    if(clientIsConnected(&_client)) {
...
bool ESPWebSocketsClient::sendPing(String & payload) {
 ...
 * @param num uint8_t client id
 */
void ESPWebSocketsClient::disconnect(void) {
    if(clientIsConnected(&_client)) {
        ESPWebSockets::clientDisconnect(&_client, 1000);
    }
}
 ...
 */
void ESPWebSocketsClient::setAuthorization(const char * user, const char * password) {
    if(user && password) {
        String auth = user;
        auth += ":";
        auth += password;
 ...
 */
void ESPWebSocketsClient::setAuthorization(const char * auth) {
    if(auth) {
 ...
 */
void ESPWebSocketsClient::setExtraHeaders(const char * extraHeaders) {
 ...
 * @param time in ms
 */
void ESPWebSocketsClient::setReconnectInterval(unsigned long time) {
    _reconnectInterval = time;
}

bool ESPWebSocketsClient::isConnected(void) {
 ...
 * @param length size_t
 */
void ESPWebSocketsClient::messageReceived(WSclient_t * client, WSopcode_t opcode, uint8_t * payload, size_t length, bool fin) {
 ...
 * @param client WSclient_t *  ptr to the client struct
 */
void ESPWebSocketsClient::clientDisconnect(WSclient_t * client) {
    bool event = false;
 ...
 */
bool ESPWebSocketsClient::clientIsConnected(WSclient_t * client) {
    if(!client->tcp) {
        return false;
    }
 ...
 */
void ESPWebSocketsClient::handleClientData(void) {
    ...
    if(len > 0) {
        switch(_client.status) {
            ...
            case WSC_CONNECTED:
                ESPWebSockets::handleWebsocket(&_client);
                break;
            default:
                ESPWebSockets::clientDisconnect(&_client, 1002);
                break;
        }
    }
    WEBSOCKETS_YIELD();
 ...
 * @param client WSclient_t *  ptr to the client struct
 */
void ESPWebSocketsClient::sendHeader(WSclient_t * client) {
...
#if(WEBSOCKETS_NETWORK_TYPE == NETWORK_ESP8266_ASYNC)
    client->tcp->readStringUntil('\n', &(client->cHttpLine), std::bind(&ESPWebSocketsClient::handleHeader, this, client, &(client->cHttpLine)));
#endif
 ...
 * @param client WSclient_t *  ptr to the client struct
 */
void ESPWebSocketsClient::handleHeader(WSclient_t * client, String * headerLine) {
...
void ESPWebSocketsClient::connectedCb() {
    DEBUG_WEBSOCKETS("[WS-Client] connected to %s:%u.\n", _host.c_str(), _port);

#if(WEBSOCKETS_NETWORK_TYPE == NETWORK_ESP8266_ASYNC)
    _client.tcp->onDisconnect(std::bind([](ESPWebSocketsClient * c, AsyncTCPbuffer * obj, WSclient_t * client) -> bool {
...
void ESPWebSocketsClient::connectFailedCb() {
    DEBUG_WEBSOCKETS("[WS-Client] connection to %s:%u Failed\n", _host.c_str(), _port);
}

#if(WEBSOCKETS_NETWORK_TYPE == NETWORK_ESP8266_ASYNC)

void ESPWebSocketsClient::asyncConnect() {
    ...
    tcpclient->onConnect(std::bind([](ESPWebSocketsClient * ws, AsyncClient * tcp) {
    ...
    tcpclient->onError(std::bind([](ESPWebSocketsClient * ws, AsyncClient * tcp) {
        ws->connectFailedCb();
 ...
 */
void ESPWebSocketsClient::handleHBPing() {
 ...
 */
void ESPWebSocketsClient::enableHeartbeat(uint32_t pingInterval, uint32_t pongTimeout, uint8_t disconnectTimeoutCount) {
    ESPWebSockets::enableHeartbeat(&_client, pingInterval, pongTimeout, disconnectTimeoutCount);
}

/**
 * disable ping/pong heartbeat process
 */
void ESPWebSocketsClient::disableHeartbeat() {
