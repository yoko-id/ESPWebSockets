...
#ifndef ESPWEBSOCKETSSERVER_H_
#define ESPWEBSOCKETSSERVER_H_
...
class ESPWebSocketsServerCore : protected ESPWebSockets {
  public:
    ESPWebSocketsServerCore(const String & origin = "", const String & protocol = "");
    virtual ~ESPWebSocketsServerCore(void);
...
class ESPWebSocketsServer : public ESPWebSocketsServerCore {
  public:
    ESPWebSocketsServer(uint16_t port, const String & origin = "", const String & protocol = "");
    virtual ~ESPWebSocketsServer(void);
