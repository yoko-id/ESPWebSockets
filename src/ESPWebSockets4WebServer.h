...
#ifndef __ESPWEBSOCKETS4WEBSERVER_H
#define __ESPWEBSOCKETS4WEBSERVER_H
...
class ESPWebSockets4WebServer : public ESPWebSocketsServerCore {
  public:
    ESPWebSockets4WebServer(const String & origin = "", const String & protocol = "")
        : ESPWebSocketsServerCore(origin, protocol) {
        begin();
    }

    ESP8266WebServer::HookFunction hookForWebserver(const String & wsRootDir, ESPWebSocketServerEvent event) {
        onEvent(event);
