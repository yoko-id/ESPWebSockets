...
#ifndef ESPSOCKETIOCLIENT_H_
#define ESPSOCKETIOCLIENT_H_
...
class ESPSocketIOclient : protected ESPWebSocketsClient {
  public:
#ifdef __AVR__
    ...
    ESPSocketIOclient(void);
    virtual ~ESPSocketIOclient(void);

    void begin(const char * host, uint16_t port, const char * url = "/socket.io/?EIO=3", const char * protocol = "");
    void begin(String host, uint16_t port, String url = "/socket.io/?EIO=3", String protocol = "");

#ifdef HAS_SSL
    void beginSSL(const char * host, uint16_t port, const char * url = "/socket.io/?EIO=3", const char * protocol = "");
    void beginSSL(String host, uint16_t port, String url = "/socket.io/?EIO=3", String protocol = "");
#ifndef SSL_AXTLS
    void beginSSLWithCA(const char * host, uint16_t port, const char * url = "/socket.io/?EIO=3", const char * CA_cert = NULL, const char * protocol = "");
    void beginSSLWithCA(const char * host, uint16_t port, const char * url = "/socket.io/?EIO=3", BearSSL::X509List * CA_cert = NULL, const char * protocol = "");
